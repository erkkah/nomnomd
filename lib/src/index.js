...
function main(args) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var parsed, allFiles, _b, markdownFiles, otherFiles, target, themeFile, themeCSS, codeTheme, servePort, cleanup, fallback;
        return __generator(this, function (_c) {
            ...
            allFiles = files_1.resolveFiles(parsed["_"], !!parsed["-r"] || !!parsed["--recursive"]);
            _b = __read(separateFilesToMarkdownAndOthers(allFiles), 2), markdownFiles = _b[0], otherFiles = _b[1];
...
function processFiles(files, target, themeCSS, codeTheme, hotReload) {
    ...
    var script = html_1.unzoomScript + (hotReload ? html_1.reloadScript : "");
    try {
        for (var files_3 = __values(files), files_3_1 = files_3.next(); !files_3_1.done; files_3_1 = files_3.next()) {
            ...
            try {
                ...
                frontmatterData = {};
                var content = md.render(text.toString(), {
                    cwd: path_1.resolve(fileDir),
                });
...
function separateFilesToMarkdownAndOthers(files) {
    return files_1.separateFilesByExtension(files, ".md");
}
